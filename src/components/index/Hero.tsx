      ...
      <section className="max-w-4xl w-full flex flex-col mx-auto pt-44">
        ...
        >
          <h1 className="font-leaguespartan font-bold lg:text-7xl md:text-6xl sm:text-5xl text-4xl text-text">
            Hey, I&apos;m Denzel<span className="sm:hidden inline-block animate-wave ml-2">👋</span><span className="font-leaguespartan font-bold text-xl text-text brightness-50 italic sm:inline flex"> aka denzelxrt</span><span className="sm:inline-block hidden animate-wave ml-2">👋</span>
          </h1>
          <p className="font-leaguespartan font-semibold lg:text-3xl md:text-2xl sm:text-xl text-lg text-text">
            {inView &&
              <Typewriter
                options={{
                  delay: 30,
                  strings: ["I'm a 15 year old full-stack developer located near London 💂"],
                  loop: false,
                  autoStart: true,
          ...
          <ul className="flex flex-row flex-wrap gap-2 mt-2">
            <SocialIcon
              url="https://github.com/denzelxrt"
